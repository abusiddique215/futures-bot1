...
| D2 | **Target instrument: MNQ (Micro E-mini Nasdaq-100)** primary, NQ-full optional later | $50K Combine has $2K MLL → one NQ-full bad trade ($20/pt × 100 pts) wipes the eval. MNQ ($2/pt) gives 10× more headroom. Both contracts allowed by Topstep. |
